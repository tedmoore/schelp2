...
For any class where it is appropriate, a separate gui class is implemented, usually inheriting much of its behavior from the gui class of its superclass.see [ObjectGui](../Classes/ObjectGui.md)
