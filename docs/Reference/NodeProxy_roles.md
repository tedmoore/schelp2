...
**Related:** [NodeProxy](../Classes/NodeProxy.md), [Ndef](../Classes/Ndef.md), [ProxySpace](../Classes/ProxySpace.md)
...
## Adding new roles
Roles can be added on the fly. They are kept in a dictionary ( **buildMethods** ) in [AbstractPlayControl](../Classes/AbstractPlayControl.md). A second dictionary ( **proxyControlClasses** ) provides the wrapper class for a given key.
