...
*set a (number) parameter in an environment conditionally*

**Categories:** JITLib>GUI

**Related:** [softSet](../Reference/softSet.md), [softVol_](../Reference/softVol_.md)

## Description

`softPut` is an extension method to [Dictionary](../Classes/Dictionary.md) that changes an existing numerical value for key in a dictionary only in two conditions:
...
| `spec` | a [ControlSpec](../Classes/ControlSpec.md) can be passed in. if nil, param.asSpec is used.
