...
**Related:** [softVol_](../Reference/softVol_.md), [softPut](../Reference/softPut.md)

## Description

`softSet` is an extension method to [NodeProxy](../Classes/NodeProxy.md) and [Ndef](../Classes/Ndef.md) that sets a nodeproxy param value only in two conditions:
