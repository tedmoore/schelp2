...
**Related:** [RandID](../Classes/RandID.md)
...
See [RandID](../Classes/RandID.md) UGen for setting the randgen id and [randomSeed](../Reference/randomSeed.md) for the client side equivalent.
