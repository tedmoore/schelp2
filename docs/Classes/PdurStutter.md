...
**Related:** [Psubdivide](../Classes/Psubdivide.md), [Pdup](../Classes/Pdup.md)

**Categories:** Streams-Patterns-Events>Patterns>Repetition


> **Note:** It is recommended to use [Psubdivide](../Classes/Psubdivide.md) instead. This class is retained for backwards compatibility.



> **⚠️ Warning:** PdurStutter will return [Psubdivide](../Classes/Psubdivide.md)
## Description
