...
**Related:** [Ppar](../Classes/Ppar.md), [Pbus](../Classes/Pbus.md), [Pgroup](../Classes/Pgroup.md)
...
> **Note:** In order to fully separate these layers from other synths, use [Pbus](../Classes/Pbus.md).


See [Pgroup](../Classes/Pgroup.md) for a description of the `\groupReleaseTime` event key.
