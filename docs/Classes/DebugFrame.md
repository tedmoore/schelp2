...
### `functionDef`
Returns a [FunctionDef](../Classes/FunctionDef.md) or a [Method](../Classes/Method.md) of the current function or method.
### `caller`
...
### `address`
Returns a [RawPointer](../Classes/RawPointer.md), rarely useful.
### `context`
