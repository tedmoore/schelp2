...
**Related:** [Gendy1](../Classes/Gendy1.md), [Gendy2](../Classes/Gendy2.md)

**Categories:** UGens>Generators>Stochastic

## Description

See [Gendy1](../Classes/Gendy1.md) help file for background. This variant of GENDYN normalises the durations in each period to force oscillation at the desired pitch. The breakpoints still get perturbed as in [Gendy1](../Classes/Gendy1.md) .
...
|----------|-------------|
| `ampdist` | Choice of probability distribution for the next perturbation of the amplitude of a control point.The distributions are (adapted from the GENDYN program in Formalized Music):| 0: | LINEAR. | 
| --- | --- || 1: | CAUCHY. | | 2: | LOGIST. | | 3: | HYPERBCOS. | | 4: | ARCSINE. | | 5: | EXPON. | | 6: | SINUS. | Where the sinus (Xenakis' name) is in this implementation taken as sampling from a third party oscillator. See example below. |  
