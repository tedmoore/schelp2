...
**Related:** [Dibrown](../Classes/Dibrown.md), [Demand](../Classes/Demand.md), [Duty](../Classes/Duty.md), [TDuty](../Classes/TDuty.md)

**Categories:** UGens>Demand

## Description

Dbrown returns numbers in the continuous range between `lo` and `hi`, [Dibrown](../Classes/Dibrown.md) returns integer values.
