...
|----------|-------------|
| `red` | An instance of [Float](../Classes/Float.md) between 0 and 1. |  
...
| Argument | Description |
|----------|-------------|
| `red` | An instance of [Integer](../Classes/Integer.md) between 0 and 255. |  
| `green` | An [Integer](../Classes/Integer.md) between 0 and 255. |  
...
| Argument | Description |
|----------|-------------|
| `hue` | [Float](../Classes/Float.md) between 0 and 0.999. |  
| `sat` | [Float](../Classes/Float.md) between 0 and 1. |  
| `val` | [Float](../Classes/Float.md) between 0 and 1. |  
| `alpha` | [Float](../Classes/Float.md) between 0 and 1. |  
