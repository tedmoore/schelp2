...
**Related:** [Done](../Classes/Done.md), [PauseSelfWhenDone](../Classes/PauseSelfWhenDone.md), [Done](../Classes/Done.md)
...
See [Done](../Classes/Done.md) for a complete list of these UGens.
Note that many of these UGens have doneActions, which are another way of accomplishing the same thing. See [Done](../Classes/Done.md) for more detail.

> **Note:** One must be careful when using binary operations on UGens with done flags, as these will return a [BinaryOpUGen](../Classes/BinaryOpUGen.md), and thus prevent the done flag from being accessible. See example below.
