...
*Controller class for MVC architecture, superclass for all XYZGui classes*

**Related:** [gui](../Reference/gui.md)
...
|----------|-------------|
| `model` | The model is the object that the GUI is a graphical interface for. |  
