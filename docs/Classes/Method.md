...
### `ownerClass`
**Returns:** The [Class](../Classes/Class.md) for which the method is part of the implementation.
### `name`
**Returns:** A [Symbol](../Classes/Symbol.md) which is the name of the Method.
### `primitiveName`
**Returns:** A [Symbol](../Classes/Symbol.md) which contains the name of the primitive function that implements the Method, if there is one.
### `filenameSymbol`
