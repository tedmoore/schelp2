...
**Related:** [SpecCentroid](../Classes/SpecCentroid.md), [SpecPcile](../Classes/SpecPcile.md)

## Description

Given an [FFT](../Classes/FFT.md) **chain** this calculates the *Spectral Flatness* measure, defined as a power spectrum's geometric mean divided by its arithmetic mean. This gives a measure which ranges from approx 0 for a pure sinusoid, to approx 1 for white noise.
