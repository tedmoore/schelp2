...
**Related:** [AllpassL](../Classes/AllpassL.md), [AllpassN](../Classes/AllpassN.md), [BufAllpassC](../Classes/BufAllpassC.md)
...
See also [AllpassN](../Classes/AllpassN.md) which uses no interpolation, and [AllpassL](../Classes/AllpassL.md) which uses linear interpolation. Cubic interpolation is more computationally expensive than linear, but more accurate.
