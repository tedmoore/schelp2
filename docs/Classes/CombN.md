...
**Related:** [CombC](../Classes/CombC.md), [CombL](../Classes/CombL.md), [BufCombN](../Classes/BufCombN.md)

**Categories:** UGens>Delays

## Description

Comb delay line with no interpolation. See also [CombL](../Classes/CombL.md)which uses linear interpolation, and [CombC](../Classes/CombC.md) which uses cubic interpolation. Cubic and linear interpolation are more computationally expensive, but more accurate.
