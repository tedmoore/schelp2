...
**Related:** [CombC](../Classes/CombC.md), [CombN](../Classes/CombN.md), [BufCombL](../Classes/BufCombL.md)

**Categories:** UGens>Delays

## Description

Comb delay line with linear interpolation. See also [CombN](../Classes/CombN.md)which uses no interpolation, and [CombC](../Classes/CombC.md) which uses cubic interpolation. Cubic interpolation is more computationally expensive than linear, but more accurate.
