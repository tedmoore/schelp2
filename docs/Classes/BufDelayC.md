...
**Related:** [BufDelayL](../Classes/BufDelayL.md), [BufDelayN](../Classes/BufDelayN.md), [DelayC](../Classes/DelayC.md)

**Categories:** UGens>Delays>Buffer

## Description

Simple delay line with cubic interpolation which uses a buffer for its internal memory. See also [BufDelayN](../Classes/BufDelayN.md) which uses no interpolation, and [BufDelayL](../Classes/BufDelayL.md) which uses linear interpolation. Cubic interpolation is more computationally expensive than linear, but more accurate.
