...
**Related:** [Env](../Classes/Env.md)

## Description

Envelope generator for polling values from an envelope. IEnvGen plays back break point envelopes from the `index` point. The envelopes are instances of the [Env](../Classes/Env.md) class.
...
| `index` | a point to access within the Env |  
| `mul` |  |  
| `add` |  |  
