...
**Related:** [Server](../Classes/Server.md), [ServerTree](../Classes/ServerTree.md)

## Description

[NodeTreeView](../Classes/NodeTreeView.md) shows the node tree on a server.
...
|----------|-------------|
| `server` | The server to display its node tree. |  
| `bounds` | A [Rect](../Classes/Rect.md), or any object responding to the [.asRect](../Search.md#asrect) method. |  
| `parent` | The [View](../Classes/View.md) or [Window](../Classes/Window.md) where a [NodeTreeView](../Classes/NodeTreeView.md) placed. |  
