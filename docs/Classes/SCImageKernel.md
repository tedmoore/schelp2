...
**Related:** [SCImage](../Classes/SCImage.md), [SCImageFilter](../Classes/SCImageFilter.md)

## Description

`// very experimental :)`
Currently this class represents the CoreImage **CIKernel** you can apply to a [SCImage](../Classes/SCImage.md). The Kernel language is a subset of the OpenGL Shading Language. more information about the Kernel Language can be found here : [http://developer.apple.com/documentation/GraphicsImaging/CIKernelLangRef/Introduction/chapter_1_section_1.html](http://developer.apple.com/documentation/GraphicsImaging/Reference/CIKernelLangRef/Introduction/chapter_1_section_1.html)
and here: [http://developer.apple.com/documentation/GraphicsImaging/CIKernelLangRef/chapter_2_section_1.html#//apple_ref/doc/uid/TP40004397-CH206-TPXREF101](http://developer.apple.com/documentation/GraphicsImaging/Reference/CIKernelLangRef/chapter_2_section_1.html#//apple_ref/doc/uid/TP40004397-CH206-TPXREF101)
...
| --- | --- || sampler | [SCImage](../Classes/SCImage.md) | | __color | [Color](../Classes/Color.md) | | float | [Number](../Classes/Number.md) | | vec2, vec3, vec4 | [Array](../Classes/Array.md) | | __table | [SCImage](../Classes/SCImage.md) (basically the __table modifier just use Images as a data providers - LUT) | 
