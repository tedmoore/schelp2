...
### `value`
Equivalent to [#-next](#-next).
### `resume`
Equivalent to [#-next](#-next).
### `stop`
Equivalent to the Routine Function reaching its end or returning: after this, the Routine will never run again (the [#-next](#-next) method has no effect and returns `nil`), unless [#-reset](#-reset) is called.
### `reset`
Causes the Routine to start from the beginning next time [#-next](#-next) is called.If a Routine is stopped (its Function has returned or [#-stop](#-stop) has been called), it will never run again (the [#-next](#-next) method has no effect and returns `nil`), unless this method is called.A Routine cannot reset itself, except by calling [Object#-yieldAndReset](../Classes/Object.md#-yieldandreset).See also: [Object#-yield](../Classes/Object.md#-yield), [Object#-alwaysYield](../Classes/Object.md#-alwaysyield)
### `play`
