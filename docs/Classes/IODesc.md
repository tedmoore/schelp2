...
### `rate`
A [Symbol](../Classes/Symbol.md) for the rate.### `numberOfChannels`
The number of channels.### `startingChannel`
...
| --- | --- || Float | A hard-coded bus index | | UGen | The UGen providing the bus index | ### `type`
