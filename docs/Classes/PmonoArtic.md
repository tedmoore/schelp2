...
**Related:** [Pbind](../Classes/Pbind.md), [Pmono](../Classes/Pmono.md)

**Categories:** Streams-Patterns-Events>Patterns>Event

## Description

Like [Pmono](../Classes/Pmono.md), PmonoArtic plays one synth at a time (where successive events change the parameters of the existing synth node). PmonoArtic, however, allows events to re-articulate and supports staccato in the middle of a monophonic phrase.
...
If sustain >= delta, the synth will play through and its parameters will change (just like [Pmono](../Classes/Pmono.md)).
