...
**Related:** [DelTapRd](../Classes/DelTapRd.md)

## Description

Write to a buffer for a [DelTapRd](../Classes/DelTapRd.md) UGen.
...
**Returns:** phase - DelTapWr outputs its current sample value for use in the phase argument in DelTapRd
## Examples
