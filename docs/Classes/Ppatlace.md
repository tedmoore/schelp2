...
**Related:** [Place](../Classes/Place.md)

**Categories:** Streams-Patterns-Events>Patterns>List

## Description

Similar to [Place](../Classes/Place.md), but the list is an array of streams or patterns. The results of each stream will be output in turn.
