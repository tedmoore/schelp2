...
**Related:** [ProxyMixer](../Classes/ProxyMixer.md), [JITGui](../Classes/JITGui.md), [NdefGui](../Classes/NdefGui.md)

## Description

NdefMixer is nearly identical to [ProxyMixer](../Classes/ProxyMixer.md), except that it looks at the proxyspaces for each server that `Ndef.all` contains.
