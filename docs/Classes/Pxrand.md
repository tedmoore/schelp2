...
**Related:** [Prand](../Classes/Prand.md), [Pwrand](../Classes/Pwrand.md)

**Categories:** Streams-Patterns-Events>Patterns>List

## Description

Like [Prand](../Classes/Prand.md), returns one item from the list at random for each repeat, but Pxrand never repeats the same element twice in a row.
