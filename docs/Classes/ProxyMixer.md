...
**Related:** [ProxySpace](../Classes/ProxySpace.md), [Ndef](../Classes/Ndef.md), [JITGui](../Classes/JITGui.md), [NdefGui](../Classes/NdefGui.md), [MonitorGui](../Classes/MonitorGui.md), [NdefParamGui](../Classes/NdefParamGui.md)
...
|----------|-------------|
| `obj` | the proxyspace to show and control |  
| `numItems` | how many ar and kr proxies can be shown |  
| `parent` | by default nil, so a window is made automatically. if a parent is supplied, the ProxyMixer will be shown there. |  
