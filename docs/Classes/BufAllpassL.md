...
**Related:** [BufAllpassC](../Classes/BufAllpassC.md), [BufAllpassN](../Classes/BufAllpassN.md), [AllpassL](../Classes/AllpassL.md)

**Categories:** UGens>Delays>Buffer

## Description

All pass delay line with linear interpolation which uses a buffer for its internal memory. See also [BufAllpassN](../Classes/BufAllpassN.md) which uses no interpolation, and which [BufAllpassC](../Classes/BufAllpassC.md) uses cubic interpolation. Cubic interpolation is more computationally expensive than linear, but more accurate.
