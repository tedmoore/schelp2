...
For tab delimited files use [TabFileReader](../Classes/TabFileReader.md). For comma-separated files use [CSVFileReader](../Classes/CSVFileReader.md). For space-delimited files, or custom delimiters, use [FileReader](../Classes/FileReader.md).
