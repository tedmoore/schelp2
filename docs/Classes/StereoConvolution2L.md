...
**Related:** [Convolution](../Classes/Convolution.md), [Convolution2L](../Classes/Convolution2L.md)
...
Like [Convolution2L](../Classes/Convolution2L.md), but convolves with two buffers and outputs a stereo signal. This saves one FFT transformation per period, as compared to using two copies of [Convolution2L](../Classes/Convolution2L.md).
