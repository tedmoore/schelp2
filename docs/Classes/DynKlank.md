...
**Related:** [Klang](../Classes/Klang.md), [DynKlang](../Classes/DynKlang.md), [Klank](../Classes/Klank.md)
...
Unlike [Klank](../Classes/Klank.md), all parameters in DynKlank can be changed in real-time after it has been started.
...
|----------|-------------|
| `specificationsArrayRef` | A Ref to an Array of three Arrays: `[frequencies, amplitudes, ringtimes]`
**frequencies:**
