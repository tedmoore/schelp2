...
**Related:** [MIDIClient](../Classes/MIDIClient.md), [MIDIOut](../Classes/MIDIOut.md), [MIDIFunc](../Classes/MIDIFunc.md), [MIDIdef](../Classes/MIDIdef.md), [MIDI](../Guides/MIDI.md), [UsingMIDI](../Guides/UsingMIDI.md)
...
> **Note:** For general programming, **users should not use the MIDIIn class directly**. See the [MIDIFunc](../Classes/MIDIFunc.md) and [MIDIdef](../Classes/MIDIdef.md) classes for higher level event matching and more flexible handling of event handlers.
...
### `addFuncTo`
Add a [Function](../Classes/Function.md) or similar object to be evaluated whenever a particular MIDI message is received. This method is preferable to the setters below, since it will not overwrite any existing functions.**Arguments:**
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI noteOn message is received. It is passed the following arguments:
**uid**
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI noteOff message is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI polytouch message is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI control change message (CC) is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI program change message is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI after-touch message is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI pitch wheel change message is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI System Exclusive message is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
...
| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI System Real-Time message is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
...
| --- | --- || 0 | frames low nibble | | 1 | frames hi nibble | | 2 | seconds low nibble | | 3 | seconds hi nibble | | 4 | minutes low nibble | | 5 | minutes hi nibble | | 6 | hours low nibble | | 7 | hours hi *bit* OR'ed with frameRate0 -> 24 fps2 -> 25 fps4 -> 30 fps drop frame6 -> 30 fps | Nibbles are sent in ascending order.**Arguments:**

| Argument | Description |
|----------|-------------|
| `value` | a [Function](../Classes/Function.md) evaluated whenever a MIDI smpte message is received. It is passed the following arguments:
**uid**
: unique identifier of the MIDI port
