...
**Related:** [Pspawn](../Classes/Pspawn.md)
...
|----------|-------------|
| `routineFunc` | The function defines a [Routine](../Classes/Routine.md) that receives a [Spawner](../Classes/Spawner.md) as its sole argument. All control of subpatterns is through the spawner.[Spawner](../Classes/Spawner.md) responds to the messages:
**par**
...
> **Note:** These are also documented in [Spawner](../Classes/Spawner.md). |  
