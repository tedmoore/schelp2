...
**Related:** [OSCFunc](../Classes/OSCFunc.md), [OSCdef](../Classes/OSCdef.md), [OSC_communication](../Guides/OSC_communication.md), [OSCpathResponder](../Classes/OSCpathResponder.md), [NetAddr](../Classes/NetAddr.md)
...
Register a function to be called upon receiving a specific command from a specific OSC address. Same interface like [OSCresponder](../Classes/OSCresponder.md), but allows **multiple responders to the same command**.
...
a = OSCresponderNode(s.addr, '/tr', { |time, responder, msg|
    [time, responder, msg].postln;
}).add;
b = OSCresponderNode(s.addr, '/tr', { |time, responder, msg|
...
a = OSCresponderNode(s.addr, '/n_end', { |time, responder, msg|
    [time, responder, msg].postln;
    if(msg[1] == g.nodeID, {
        "g is dead !".postln;
        // g = Group.new;
