...
*mix control for a proxyspace*

**Categories:** JITLib>GUI

**Related:** [ProxySpace](../Classes/ProxySpace.md), [NodeProxyEditor](../Classes/NodeProxyEditor.md)

## Description

> **⚠️ Warning:** ProxyMixer has been updated - some little adaptations to existing uses may be needed. If you like, you can also replace "ProxyMixer" with "ProxyMixerOld" to keep using the old style of ProxyMixer.
...
|----------|-------------|
| `proxyspace` | a [ProxySpace](../Classes/ProxySpace.md) |  
