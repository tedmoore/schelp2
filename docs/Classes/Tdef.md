...
**Related:** [TaskProxy](../Classes/TaskProxy.md), [Task](../Classes/Task.md), [Routine](../Classes/Routine.md)
...
Graphical overview over all current Tdefs: [TdefAllGui](../Classes/TdefAllGui.md). Overview: [JITLib](../Overviews/JITLib.md)
...
| Argument | Description |
|----------|-------------|
| `clock` | the clock on which to play the forked task |  
