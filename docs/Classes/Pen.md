...
**Related:** [QPenPrinter](../Classes/QPenPrinter.md)

## Description

A class which allows you to draw custom graphics on a UserView or Window.
The following methods must be called within a [Window#-drawFunc](../Classes/Window.md#-drawfunc) or a [UserView#-drawFunc](../Classes/UserView.md#-drawfunc) function, and will only be visible once the window or the view is refreshed. Each call to [Window#-refresh](../Classes/Window.md#-refresh) or [UserView#-refresh](../Classes/UserView.md#-refresh) will 'overwrite' all previous drawing by executing the currently defined function, unless [UserView#-clearOnRefresh](../Classes/UserView.md#-clearonrefresh) is set to `false`
...
| Argument | Description |
|----------|-------------|
| `point1` | The end point of the first tangent line. Its start point is the current position. An instance of [Point](../Classes/Point.md) |  
