...
**quant = 1**
: schedule for the next whole beat

**quant = 4, phase = -1**
: a one beat pick-up to the next 4/4 barline


Suppose the clock's meter was 3/4 for 3 bars (starting at 0). Then:

**quant = 3, phase = 1**
: would schedule for 1, 4, or 7 beats


During this time, clock.setMeterAtBeat(4, 9) is executed. Then:

**quant = 4, phase = 0**
: would schedule for 9, 13, 17, 21 etc. beats
...
Certain objects convert themselves into Quant objects when used with [Routine#-play](../Classes/Routine.md#-play), [Task#-play](../Classes/Task.md#-play) or [Pattern#-play](../Classes/Pattern.md#-play).


**[SimpleNumber](../Classes/SimpleNumber.md)**
: `4.0 --> Quant(4.0, nil, nil)`

**[Array](../Classes/Array.md)**
: `[4.0, 1.0] --> Quant(4.0, 1.0, nil)``[4.0, 1.0, 0.1] --> Quant(4.0, 1.0, 0.1)`

**[Nil](../Classes/Nil.md)**
: `nil --> Quant(nil, nil, nil)`
