...
**Related:** [OSCFunc](../Classes/OSCFunc.md), [SendReply](../Classes/SendReply.md)
...
|----------|-------------|
| `in` | The trigger. |  
| `id` | An integer that will be passed with the trigger message. This is useful if you have more than one SendTrig in a SynthDef. |  
