...
**Related:** [BeatTrack](../Classes/BeatTrack.md), [MFCC](../Classes/MFCC.md), [Onsets](../Classes/Onsets.md), [Pitch](../Classes/Pitch.md), [KeyTrack](../Classes/KeyTrack.md)
...
|----------|-------------|
| `chain` | [fft] Audio input to track, which has been pre-analysed by the [FFT](../Classes/FFT.md) [UGen](../Classes/UGen.md); see examples below for the expected FFT size. |  
