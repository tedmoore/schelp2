...
**Related:** [Pmul](../Classes/Pmul.md), [Paddp](../Classes/Paddp.md)
...
|----------|-------------|
| `name` | the named value in the event pattern or stream to multiply. |  
| `value` | The value, pattern, stream or array to multiply with. The resulting stream ends when this incoming stream ends. |  
| `pattern` | The event pattern or stream within which to multiply the new values. |  
