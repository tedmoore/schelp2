...
**Related:** [FFT](../Classes/FFT.md), [IFFT](../Classes/IFFT.md), [PV_MagShift](../Classes/PV_MagShift.md)
...
| `interp` | Set to 0 (default) for no interpolation, or 1 to linear-interpolate between bins. |  
