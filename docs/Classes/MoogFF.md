...
**Related:** [RLPF](../Classes/RLPF.md), [LPF](../Classes/LPF.md)

## Description

A digital implementation of the Moog VCF (filter).> *The design of this filter is described in the conference paper Fontana, F. (2007) *Preserving the Digital Structure of the Moog VCF*. In Proc. ICMC07, Copenhagen, 25-31 August 2007.*> *Original Java code created by F. Fontana - August 2007 - federico.fontana@univr.it Ported to C++ for SuperCollider by Dan Stowell*
