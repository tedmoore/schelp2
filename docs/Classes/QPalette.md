...
### `window`
 Convenience method to get or set the color for the 'window' role.### `windowText`
 Convenience method to get or set the color for the 'windowText' role.### `button`
 Convenience method to get or set the color for the 'button' role.### `buttonText`
 Convenience method to get or set the color for the 'buttonText' role.### `base`
 Convenience method to get or set the color for the 'base' role.### `baseText`
 Convenience method to get or set the color for the 'baseText' role.### `highlight`
 Convenience method to get or set the color for the 'highlight' role.### `highlightText`
