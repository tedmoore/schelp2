...
**Related:** [AllpassC](../Classes/AllpassC.md), [AllpassL](../Classes/AllpassL.md), [BufAllpassN](../Classes/BufAllpassN.md)
...
This UGen quantizes the delay time to the nearest sample period, and will produce aliasing artifacts if the delay time is modulated. If these are undesirable properties, the more CPU-expensive alternatives are [AllpassL](../Classes/AllpassL.md) which uses linear interpolation, and [AllpassC](../Classes/AllpassC.md) which uses cubic interpolation.
