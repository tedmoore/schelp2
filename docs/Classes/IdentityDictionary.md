...
### `know`
If set to true, the dictionary interprets method calls as look ups. This allows you to implement object prototypes (see above).### `putGet`
...
If such reverse lookup is needed a lot, for efficiency you may consider using a [TwoWayIdentityDictionary](../Classes/TwoWayIdentityDictionary.md) instead.### `proto`, `parent`
...
![IdentityDictionary_01.png#Example schema: order of overriding in proto and parent.](IdentityDictionary_01.png#Example schema: order of overriding in proto and parent.)### `insertParent`
