...
**Related:** [Pkey](../Classes/Pkey.md), [Pchain](../Classes/Pchain.md)
...
|----------|-------------|
| `pattern` | pattern or stream that returns or modifies events. |  
| `event` | an event with objects to embed. If none is provided, it uses [Event#*default](../Classes/Event.md#*default). |  
