...
**Related:** [Pdefn](../Classes/Pdefn.md), [PdefGui](../Classes/PdefGui.md)
...
For **non-event patterns** [Pdefn](../Classes/Pdefn.md) is used instead. For another use of Pdef see also [JITLib/recursive_phrasing](../Tutorials/JITLib/recursive_phrasing.md). Graphical overview over all current Pdefs: [PdefAllGui](../Classes/PdefAllGui.md). Overview: [JITLib](../Overviews/JITLib.md).
...
| Argument | Description |
|----------|-------------|
| `argClock` | The clock to run the substream on. |  
