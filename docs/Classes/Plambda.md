...
**Related:** [Penvir](../Classes/Penvir.md), [Pkey](../Classes/Pkey.md)
...
Used in combination with [Plet](../Classes/Plet.md) and [Pget](../Classes/Pget.md), it allows you to get the output of a pattern from one stream and use it in another stream and as such create a dataspace for your patterns.
...
|----------|-------------|
| `pattern` | an event stream. |  
| `scope` | an event with default bindings (can be nil). |  
