...
**Related:** [Pwhile](../Classes/Pwhile.md)
...
|----------|-------------|
| `condition` | A pattern or stream returning a [Boolean](../Classes/Boolean.md) value. |  
| `iftrue` | This stream is evaluated if the [Boolean](../Classes/Boolean.md) is true. |  
| `iffalse` | This stream is evaluated if the [Boolean](../Classes/Boolean.md) is false. |  
