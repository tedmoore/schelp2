...
**Related:** [Amplitude](../Classes/Amplitude.md), [Compander](../Classes/Compander.md), [Normalizer](../Classes/Normalizer.md), [Limiter](../Classes/Limiter.md)
...
If any of this is confusing, see [http://en.wikipedia.org/wiki/Audio_level_compression](http://en.wikipedia.org/wiki/Audio_level_compression)
