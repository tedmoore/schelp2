...
For semi-colon-delimited files use [SemiColonFileReader](../Classes/SemiColonFileReader.md). For comma-separated files use [CSVFileReader](../Classes/CSVFileReader.md). For space-delimited files, or custom delimiters, use [FileReader](../Classes/FileReader.md).
