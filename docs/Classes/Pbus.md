...
**Related:** [Pfx](../Classes/Pfx.md), [Pfxb](../Classes/Pfxb.md), [Pgroup](../Classes/Pgroup.md)
...
This is useful in order to isolate a [Pfx](../Classes/Pfx.md).
...
| `numChannels` | number of channels of the bus (should match the synthdef). |  
| `rate` | bus rate. |  
