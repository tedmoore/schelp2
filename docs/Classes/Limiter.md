...
**Related:** [Amplitude](../Classes/Amplitude.md), [Compander](../Classes/Compander.md), [CompanderD](../Classes/CompanderD.md), [Normalizer](../Classes/Normalizer.md)

**Categories:** UGens>Dynamics

## Description

Limits the input amplitude to the given level. Limiter will not overshoot like [Compander](../Classes/Compander.md) will, but it needs to look ahead in the audio. Thus there is a delay equal to twice the value of the `dur` parameter.
