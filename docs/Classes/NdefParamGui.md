...
**Related:** [EZText](../Classes/EZText.md), [NdefGui](../Classes/NdefGui.md), [EnvirGui](../Classes/EnvirGui.md)

## Description

NdefParamGui displays all settings and mappings of a nodeproxy, so one can change them flexibly. Single number get displayed with an [EZSlider](../Classes/EZSlider.md), and anything else is shown as an [EZText](../Classes/EZText.md) (a text field). Its main use is within [NdefGui](../Classes/NdefGui.md).
It inherits some useful methods from [EnvirGui](../Classes/EnvirGui.md).
