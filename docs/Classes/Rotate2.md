...
**Related:** [BiPanB2](../Classes/BiPanB2.md), [DecodeB2](../Classes/DecodeB2.md), [PanB](../Classes/PanB.md), [PanB2](../Classes/PanB2.md)
...
| `x` | Input signal X. |  
| `y` | Input signal Y. |  
| `pos` | angle to rotate around the circle from -1 to +1. -1 is 180 degrees, -0.5 is left, 0 is forward, +0.5 is right, +1 is behind. |  
