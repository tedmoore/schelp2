...
### `id`
The node ID. A [Symbol](../Classes/Symbol.md)
### `text`
Text associated with this node. A [String](../Classes/String.md) or nil.
### `children`
Children of this node. A [Array](../Classes/Array.md) or nil.
### `merge`
