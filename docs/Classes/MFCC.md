...
**Related:** [BeatTrack](../Classes/BeatTrack.md), [Loudness](../Classes/Loudness.md), [Onsets](../Classes/Onsets.md), [Pitch](../Classes/Pitch.md), [KeyTrack](../Classes/KeyTrack.md)
...
| `numcoeff` | [s] Number of coefficients, defaults to 13, maximum of 42; more efficient to use less of course! |  
**Returns:** `#coeff1, coeff2, ...`
## Examples
