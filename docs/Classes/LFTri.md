...
**Related:** [LFCub](../Classes/LFCub.md), [LFPar](../Classes/LFPar.md), [LFPulse](../Classes/LFPulse.md), [LFSaw](../Classes/LFSaw.md)
...
|----------|-------------|
| `freq` | Frequency in Hertz. For efficiency reasons, only positive values result in correct behavior. |  
