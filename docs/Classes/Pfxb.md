...
**Related:** [Pfx](../Classes/Pfx.md), [Pbus](../Classes/Pbus.md), [Pgroup](../Classes/Pgroup.md)
...
In difference to [Pfx](../Classes/Pfx.md), a **private effect bus** is provided according to the number of channels in the effect synth def.
