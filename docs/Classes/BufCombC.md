...
**Related:** [BufCombL](../Classes/BufCombL.md), [BufCombN](../Classes/BufCombN.md), [CombC](../Classes/CombC.md)

**Categories:** UGens>Delays>Buffer

## Description

Comb delay line with cubic interpolation which uses a buffer for its internal memory. See also [BufCombN](../Classes/BufCombN.md) which uses no interpolation, and [BufCombL](../Classes/BufCombL.md) which uses linear interpolation. Cubic interpolation is more computationally expensive than linear, but more accurate.
