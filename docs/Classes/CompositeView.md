...
**Related:** [FlowView](../Classes/FlowView.md), [FlowLayout](../Classes/FlowLayout.md)

## Description


> **Note:** In Qt GUI, every view can be a parent to other views, so CompositeView redirects to the same class as [View](../Classes/View.md) - you can use the latter equivalently.
