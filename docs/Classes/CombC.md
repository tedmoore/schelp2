...
**Related:** [CombL](../Classes/CombL.md), [CombN](../Classes/CombN.md), [BufCombC](../Classes/BufCombC.md)

**Categories:** UGens>Delays

## Description

Comb delay line with cubic interpolation. See also [CombN](../Classes/CombN.md) which uses no interpolation, and [CombL](../Classes/CombL.md) which uses linear interpolation. Cubic interpolation is more computationally expensive than linear, but more accurate.
