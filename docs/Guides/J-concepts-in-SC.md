...
The J programming language is a successor of APL (see [http://www.jsoftware.com](http://www.jsoftware.com)). These languages are made for processing arrays of data and are able to express complex notions of iteration implicitly.
