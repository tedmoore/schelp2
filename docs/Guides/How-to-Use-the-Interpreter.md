...
This document is macOS (SCapp) specific in key commands, though the principles extend to all platforms. See the helpfile [KeyboardShortcuts](../Reference/KeyboardShortcuts.md) for key commands in other editors. For the emacs sclang interface please also see [EmacsEditor](../Reference/EmacsEditor.md) specific documentation.
