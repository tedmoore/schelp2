...
**Related:** [Search](../Search.md), [Browse](../Browse.md), [Help](../Help.md)
...
> **Note:** In help documents, a class name beginning with a lowercase letter typically refers to an instance of that class. For example:- The following refer to the class itself, in singular or plural form:- [Set](../Classes/Set.md)
- `Set`
- Set
- [Set](../Classes/Set.md)s
- `Set`s
- Sets

- The following refer to one or more instances of the [Set](../Classes/Set.md) class:- a set
- sets
...
In addition there are a many helpfiles which explain important concepts. See the [category browser](../Browse.md) and the [search page](../Search.md).
...
In general poking around can be a good way to learn about how things work. See [Internal-Snooping](../Guides/Internal-Snooping.md) for more advanced information about how to look 'under the hood.'
...
[http://supercollider.sourceforge.net/wiki](http://supercollider.sourceforge.net/wiki)
...
[https://github.com/supercollider/supercollider/issues](https://github.com/supercollider/supercollider/issues)
