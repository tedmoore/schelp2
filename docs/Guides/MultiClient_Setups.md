...
**Related:** [ServerOptions](../Classes/ServerOptions.md), [Server](../Classes/Server.md)
...
For info on what a default group is, see [default_group](../Reference/default_group.md).
