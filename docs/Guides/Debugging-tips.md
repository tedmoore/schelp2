...
*tips on debugging synthdefs, client code and more*

**Categories:** Language, Debugging

**Related:** [Understanding-Errors](../Guides/Understanding-Errors.md)
...
### Trace control signals using a control bus
...
Some bugs result from OSC messages to the server being constructed incorrectly. Julian Rohrhuber's DebugNetAddr is a convenient way to capture messages. The class may be downloaded from: [http://swiki.hfbk-hamburg.de](http://swiki.hfbk-hamburg.de):8888/MusicTechnology/710 .
...
See the [Understanding-Errors](../Guides/Understanding-Errors.md) help file for a tutorial.
