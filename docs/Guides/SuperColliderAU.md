...
[http://swiki.hfbk-hamburg.de](http://swiki.hfbk-hamburg.de):8888/MusicTechnology/823
...
### serverConfig.plist
Stores configuration parameters for the server (see [ServerOptions](../Classes/ServerOptions.md))
