...
All [UGen](../Classes/UGen.md)s have only a single output. This uniformity facilitates the use of array operations to perform manipulation of multi channel structures.
...
The expansion is handled by wrapper-methods defined in [SequenceableCollection](../Classes/SequenceableCollection.md).
...
### Using flop and flop1 for multichannel expansion
