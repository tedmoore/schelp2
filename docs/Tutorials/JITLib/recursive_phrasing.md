...
**Related:** [Overviews/JITLib](../../Overviews/JITLib.md), [Pdef](../../Classes/Pdef.md), [PlazyEnvirN](../../Classes/PlazyEnvirN.md)
...
- if there is no definition to be found there, it uses a [SynthDef](../../Classes/SynthDef.md) with this name, if present.
