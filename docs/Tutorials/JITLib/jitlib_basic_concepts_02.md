...
**Related:** [Overviews/JITLib](../../Overviews/JITLib.md), [JITLib/jitlib_basic_concepts_01](../../Tutorials/JITLib/jitlib_basic_concepts_01.md), [JITLib/jitlib_basic_concepts_03](../../Tutorials/JITLib/jitlib_basic_concepts_03.md)

external structure of the node proxy, referencing in proxyspace and environments.
This document covers:
- [a) normal environment lookup](#a)-normal-environment-lookup)
- [b) a proxyspace as an environment](#b)-a-proxyspace-as-an-environment)
- [c) using the proxyspace to change processes on the fly](#c)-using-the-proxyspace-to-change-processes-on-the-fly)
- [d) when are the node proxies initialized?](#d)-when-are-the-node-proxies-initialized?)
- [e) moving out of the proxy space](#e)-moving-out-of-the-proxy-space)
- [f) using ProxySpace together with other Environments](#f)-using-proxyspace-together-with-other-environments)
...
further readings: [Environment](../../Classes/Environment.md)
...
further readings: [JITLib/proxyspace_examples](../../Tutorials/JITLib/proxyspace_examples.md), [Bus](../../Classes/Bus.md), [AbstractFunction](../../Classes/AbstractFunction.md)
...
> **Note:** In sc3.7, you can dynamically adjust the rate and numChannels using the [NodeProxy#-mold](../../Classes/NodeProxy.md#-mold) message, and the proxy can also be set to dynamically adjust to the input ([NodeProxy#-reshaping](../../Classes/NodeProxy.md#-reshaping)).
...
previous: [JITLib/jitlib_basic_concepts_01](../../Tutorials/JITLib/jitlib_basic_concepts_01.md) next: [JITLib/jitlib_basic_concepts_03](../../Tutorials/JITLib/jitlib_basic_concepts_03.md)
