...
[NodeProxy](../../Classes/NodeProxy.md) (and, in disguise [ProxySpace](../../Classes/ProxySpace.md)) represent "pronouns", placeholders for all kinds of sound producing objects that are able to write to a specific bus on the server.
