...
### Ppar
The [Ppar](../Classes/Ppar.md) pattern allows you to merge multiple event streams to play in parallel.

Ppar is a [ListPattern](../Classes/ListPattern.md) and so like most ListPatterns it takes two arguments, a **list** of event patterns to play in parallel and a **repeats** count.
...
### Ptpar
The [Ppar](../Classes/Ppar.md) pattern starts all of its subpatterns at the same time.
...
Similarly, [Pmul](../Classes/Pmul.md) multiplies the current value of a property by a value. [Pset](../Classes/Pset.md) sets the property to a value.
...
To go to the next file: [Streams-Patterns-Events7](../Tutorials/Streams-Patterns-Events7.md)
