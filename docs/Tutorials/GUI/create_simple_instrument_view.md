# GUI: Interfacing an instrument with a View

*Creating a view that interacts with a Synth, introduction to Layouts*

**Categories:** Tutorials>GUI

**Related:** [GUI/create_window](../../Tutorials/GUI/create_window.md), [GUI/compose_complex_view](../../Tutorials/GUI/compose_complex_view.md)


## GUI Tutorial
This helpfile is part of a [GUI tutorial](../../Tutorials/GUI/tutorial_intro.md).

It is the second part of a beginner's introduction to SuperCollider's GUI system. First part covers  [creating a window](../../Tutorials/GUI/create_window.md), while third part talks about [composing views with basic GUI components](../../Tutorials/GUI/compose_complex_view.md).



## What is this tutorial about?
This is a tutorial to get started using SuperCollider's GUI system to create views and make them interact with a [Synth](../../Classes/Synth.md).
...
## Setup
You will need to boot the [Server](../../Classes/Server.md) and add a [SynthDef](../../Classes/SynthDef.md) to it which we will be using in this tutorial.
...
If this code does not make sense to you, you can find more explanations about it in [GUI/create_window](../../Tutorials/GUI/create_window.md).
...
## Adding several buttons at once
...
For now, **the Window is only containing a** [HLayout](../../Classes/HLayout.md).
...
But you cannot order views vertically. For this, you need to create a [VLayout](../../Classes/VLayout.md), which in turns, cannot order views horizontally. **To mix horizontal and vertical division of the Window, you will need to insert some layouts inside other layouts.**
...
In this case, the `action` function of the Slider will assign the sliders value to a variable called `volume`. When a key from our 'piano' is pressed, it will also check this variable to pass the right volume as argument, when evaluating the Synth command.
...
## Adapting the Slider to the correct value (mapping)
...
## Adding text, and specifying views ratios
...
The next tutorial in this series is a tour of common things you might want to implement when using GUI, for example an interface with tabs, allowing you to switch between different views. Like we did here, it is about using basic GUI components to create interfaces. You can access it here: [GUI/compose_complex_view](../../Tutorials/GUI/compose_complex_view.md).
