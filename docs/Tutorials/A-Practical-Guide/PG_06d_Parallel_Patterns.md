...
**Related:** [A-Practical-Guide/PG_06c_Composition_of_Patterns](../../Tutorials/A-Practical-Guide/PG_06c_Composition_of_Patterns.md), [A-Practical-Guide/PG_06e_Language_Control](../../Tutorials/A-Practical-Guide/PG_06e_Language_Control.md)
...
**`Ppar(list, repeats)`**
: Start each of the event patterns in the `list` at the same time. When the last one finishes, the [Ppar](../../Classes/Ppar.md) also stops. If `repeats > 1`, all the subpatterns start over again from the beginning.
...
Previous: [A-Practical-Guide/PG_06c_Composition_of_Patterns](../../Tutorials/A-Practical-Guide/PG_06c_Composition_of_Patterns.md)

Next: [A-Practical-Guide/PG_06e_Language_Control](../../Tutorials/A-Practical-Guide/PG_06e_Language_Control.md)
