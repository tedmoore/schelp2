...
**Related:** [A-Practical-Guide/PG_Cookbook05_Using_Samples](../../Tutorials/A-Practical-Guide/PG_Cookbook05_Using_Samples.md), [A-Practical-Guide/PG_Cookbook07_Rhythmic_Variations](../../Tutorials/A-Practical-Guide/PG_Cookbook07_Rhythmic_Variations.md)
...
Most conventional synthesizers have a mode where playing a note while the previous note is still sustaining slides from one note to the other. The [PmonoArtic](../../Classes/PmonoArtic.md) pattern does this based on the event's sustain value. The delta value is the number of beats until the next event; sustain is the number of beats until the note releases. If sustain is shorter than delta, the note should cut off early and the next event should produce a new synth.

The example uses [Pfsm](../../Classes/Pfsm.md) (finite state machine) to arrange a set of predefined phrases in a partially randomized order. Each phrase is followed by a list pointing to the phrases that could legitimately follow the current phrase. That is, it might make musical sense to go from phrase 1 to phrase 2, but not from 1 to 3. Defining the successors for 1 appropriately makes sure that a nonsense transition will not be made.
...
Previous: [A-Practical-Guide/PG_Cookbook05_Using_Samples](../../Tutorials/A-Practical-Guide/PG_Cookbook05_Using_Samples.md)

Next: [A-Practical-Guide/PG_Cookbook07_Rhythmic_Variations](../../Tutorials/A-Practical-Guide/PG_Cookbook07_Rhythmic_Variations.md)
