...
**Related:** [A-Practical-Guide/PG_060_Filter_Patterns](../../Tutorials/A-Practical-Guide/PG_060_Filter_Patterns.md), [A-Practical-Guide/PG_06b_Time_Based_Patterns](../../Tutorials/A-Practical-Guide/PG_06b_Time_Based_Patterns.md)
...
: If the `connected` pattern is true, [Pclutch](../../Classes/Pclutch.md) returns the next value from `pattern`. If `connected` is false, the previous pattern value is repeated. It's like a clutch in a car: when engaged, the pattern moves forward; when disconnected, it stays where it is.
...
**`Pfin(count, pattern)`**
: Returns exactly `count` values from the source pattern, then stops. ([Pfin](../../Classes/Pfin.md) has a cousin, Pfinval, that is deprecated.)
...
Previous: [A-Practical-Guide/PG_060_Filter_Patterns](../../Tutorials/A-Practical-Guide/PG_060_Filter_Patterns.md)

Next: [A-Practical-Guide/PG_06b_Time_Based_Patterns](../../Tutorials/A-Practical-Guide/PG_06b_Time_Based_Patterns.md)
