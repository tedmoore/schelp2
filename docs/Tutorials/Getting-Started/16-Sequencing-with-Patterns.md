...
**[Pseq](../../Classes/Pseq.md)(list, repeats, offset)**
: return the list's values in order

**[Pshuf](../../Classes/Pshuf.md)(list, repeats)**
: scramble the list into random order

**[Prand](../../Classes/Prand.md)(list, repeats)**
: choose from the list's values randomly

**[Pxrand](../../Classes/Pxrand.md)(list, repeats)**
: choose randomly, but never return the same list item twice in a row

**[Pwrand](../../Classes/Pwrand.md)(list, weights, repeats)**
...
**[Pseries](../../Classes/Pseries.md)(start, step, length)**
: arithmetic series, e.g., 1, 2, 3, 4, 5

**[Pgeom](../../Classes/Pgeom.md)(start, grow, length)**
: geometric series, e.g., 1, 2, 4, 8, 16

**[Pwhite](../../Classes/Pwhite.md)(lo, hi, length)**
: random number generator, uses rrand(lo, hi) -- equal distribution

**[Pexprand](../../Classes/Pexprand.md)(lo, hi, length)**
...
**[Pn](../../Classes/Pn.md)(pattern, repeats)**
: repeat the pattern as many times as repeats indicates

**[Pdup](../../Classes/Pdup.md)(n, pattern)**
...
The [Streams](../../Overviews/Streams.md) documentation explains how all of this works in detail. The high-level overview goes like this:
...
An introductory tutorial cannot cover all the possibilities. Learning a set of core pattern classes is important; the [Practical Guide to Patterns](../../Tutorials/A-Practical-Guide/PG_01_Introduction.md) help file series is a more comprehensive introduction. Pattern manipulations, and ways to combine or nest patterns, open up the field to nearly every compositional need.
...
## Further reading
[Streams](../../Overviews/Streams.md), [Streams-Patterns-Events](../../Tutorials/Streams-Patterns-Events1.md), [Practical Guide to Patterns](../../Tutorials/A-Practical-Guide/PG_01_Introduction.md)
