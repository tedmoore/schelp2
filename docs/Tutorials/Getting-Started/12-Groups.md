...
Group and Synth are subclasses of the abstract class [Node](../../Classes/Node.md). Because of this, some of their methods are defined in Node, and (perhaps more practically important) are *documented in Node's helpfile*.
...
[Group](../../Classes/Group.md), [Node](../../Classes/Node.md), [default_group](../../Reference/default_group.md), [RootNode](../../Classes/RootNode.md), [Intro-to-Objects](../../Guides/Intro-to-Objects.md), [Order-of-execution](../../Guides/Order-of-execution.md), [Synth](../../Classes/Synth.md), [More-On-Getting-Help](../../Guides/More-On-Getting-Help.md), [Internal-Snooping](../../Guides/Internal-Snooping.md)

____________________

This document is part of the tutorial **Getting Started With SuperCollider**.

Click here to go on to the next section: [Getting-Started/13-Buffers](../../Tutorials/Getting-Started/13-Buffers.md)
