...
[Multichannel-Expansion](../../Guides/Multichannel-Expansion.md), [Collections](../../Overviews/Collections.md), [Pan2](../../Classes/Pan2.md)
...
Click here to go on to the next section: [Getting-Started/07-Mix-it-Up](../../Tutorials/Getting-Started/07-Mix-it-Up.md)
