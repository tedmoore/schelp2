...
You will find numerous other examples of syntax shortcuts throughout SC's documentation. If you see something you don't recognize, a good place to check is [Syntax-Shortcuts](../../Reference/Syntax-Shortcuts.md), which gives examples of most of these.



## Snooping, etc.
SC has numerous other ways of tracking down information on classes, methods, etc. Most of these won't be too helpful for you at this point, but are good to know about for future use. Information on these can be found in the files [More-On-Getting-Help](../../Guides/More-On-Getting-Help.md) and [Internal-Snooping](../../Guides/Internal-Snooping.md).

For more information see:

[More-On-Getting-Help](../../Guides/More-On-Getting-Help.md), [Internal-Snooping](../../Guides/Internal-Snooping.md), [Syntax-Shortcuts](../../Reference/Syntax-Shortcuts.md)
...
Click here to go on to the next section: [Getting-Started/10-SynthDefs-and-Synths](../../Tutorials/Getting-Started/10-SynthDefs-and-Synths.md)
