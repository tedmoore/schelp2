...
Like busses, the number of buffers is set before you boot a server (using [ServerOptions](../../Classes/ServerOptions.md)), but before buffers can be used, you need to allocate memory to them, which is an asynchronous step. Also like busses, buffers are numbered, starting from 0. Using Buffer takes care of allocating numbers, and avoids conflicts.
...
Many of Buffer's methods have numerous arguments. Needless to say, for full information see the [Buffer](../../Classes/Buffer.md) help file.
...
This is not as flexible as PlayBuf (no rate control), but can save memory.> *For variable playback rate while streaming from disk, look at the [VDiskIn](../../Classes/VDiskIn.md) UGen.*
...
See the [RecordBuf](../../Classes/RecordBuf.md) help file for details on all of its options.
...
[Buffer](../../Classes/Buffer.md), [PlayBuf](../../Classes/PlayBuf.md), [RecordBuf](../../Classes/RecordBuf.md), [SynthDef](../../Classes/SynthDef.md), [BufRateScale](../../Classes/BufRateScale.md), [Shaper](../../Classes/Shaper.md)

____________________

This document is part of the tutorial **Getting Started With SuperCollider**.

Click here to go on to the next section: [Getting-Started/14-Scheduling-Events](../../Tutorials/Getting-Started/14-Scheduling-Events.md)
