...
![Functions-and-Sound-00.png#(don't worry about the 'index' and 'value' stuff; it's not important just now)](Functions-and-Sound-00.png#(don't worry about the 'index' and 'value' stuff; it's not important just now))
...
![Functions-and-Sound-01.png](Functions-and-Sound-01.png)
Make sense? Here are several cycles of the two side by side to make the idea clearer:

![Functions-and-Sound-02.png](Functions-and-Sound-02.png)
...
![Functions-and-Sound-03.png](Functions-and-Sound-03.png)
...
Click here to go on to the next section: [Getting-Started/06-Presented-in-Living-Stereo](../../Tutorials/Getting-Started/06-Presented-in-Living-Stereo.md)
