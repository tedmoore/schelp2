...
> **⚠️ Warning:** If you are using headphones or external speakers, it is recommended to set your volume low before playing the following example and then bring it up to a comfortable level. Raw synthesized tones can sometimes seem louder than music and the other forms of audio we usually listen to.
...
[Functions](../../Reference/Functions.md), [Function](../../Classes/Function.md), [Assignment](../../Reference/Assignment.md), [Intro-to-Objects](../../Guides/Intro-to-Objects.md), [Literals](../../Reference/Literals.md), [Scope](../../Reference/Scope.md)
____________________
This document is part of the tutorial **Getting Started With SuperCollider**.
Click here to go on to the next section: [Getting-Started/05-Functions-and-Sound](../../Tutorials/Getting-Started/05-Functions-and-Sound.md)
