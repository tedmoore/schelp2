...
See the [Symbol](../../Classes/Symbol.md) and [String](../../Classes/String.md) files in the SuperCollider help system.
...
More precisely, the ~ character puts a variable named 'aSynth' into an instance of an object known as the currentEnvironment. For further information, see the [Environment](../../Classes/Environment.md) document in the SuperCollider help system.
...
go to [Mark_Polishook_tutorial/11_Test_functions](../../Tutorials/Mark_Polishook_tutorial/11_Test_functions.md)
