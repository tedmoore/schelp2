...
See the [Server-Architecture](../../Reference/Server-Architecture.md) document for a definition of a node in SuperCollider or look to the Wikipedia for a general discussion of nodes, linked lists, and trees.

- [http://en.wikipedia.org/wiki/Node](http://en.wikipedia.org/wiki/Node)
...
go to [Mark_Polishook_tutorial/16_Playbuf](../../Tutorials/Mark_Polishook_tutorial/16_Playbuf.md)
