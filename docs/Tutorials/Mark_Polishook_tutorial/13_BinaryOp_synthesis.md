...
(Or use the [Klang](../../Classes/Klang.md) ugen to produce a similar effect).
...
go to [Mark_Polishook_tutorial/14_Subtractive_synthesis](../../Tutorials/Mark_Polishook_tutorial/14_Subtractive_synthesis.md)
