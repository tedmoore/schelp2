...
**Related:** [Streams-Patterns-Events1](../Tutorials/Streams-Patterns-Events1.md), [Streams-Patterns-Events2](../Tutorials/Streams-Patterns-Events2.md), [Streams-Patterns-Events4](../Tutorials/Streams-Patterns-Events4.md), [Streams-Patterns-Events5](../Tutorials/Streams-Patterns-Events5.md), [Streams-Patterns-Events6](../Tutorials/Streams-Patterns-Events6.md), [Streams-Patterns-Events7](../Tutorials/Streams-Patterns-Events7.md)

**Categories:** Tutorials>Streams-Patterns-Events


## ListPatterns
ListPatterns are [Pattern](../Classes/Pattern.md)s that iterate over arrays of objects in some fashion. All ListPatterns have in common the instance variables list and repeats. The list variable is some [Array](../Classes/Array.md) to be iterated over. The repeats variable is some measure of the number of times to do something, whose meaning varies from subclass to subclass. The default value for repeats is 1.
...
## Nesting Patterns
If a [Pattern](../Classes/Pattern.md) encounters another Pattern in its list, it embeds that pattern in its output. That is, it creates a stream on that pattern and iterates that pattern until it ends before moving on.
...
To go to the next file: [Streams-Patterns-Events4](../Tutorials/Streams-Patterns-Events4.md)
